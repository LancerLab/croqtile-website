---
title: "Contributing"
description: "How to build, test, and submit changes to CroqTile."
order: 20
---

## Overview

CroqTile development follows a typical open-source workflow: fork the repository, work on a branch, and open a pull request with a clear description of the change and how it was tested.
