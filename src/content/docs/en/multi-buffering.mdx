...
# Multi-Buffering Optimization with CroqTile
...
In CroqTile, this method requires two key programming primitives: the 'dummy' future **dma.any**, and the **swap/rotate** function. Let's illustrate by an example:
